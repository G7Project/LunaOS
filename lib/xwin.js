...
// XWin pre1
export function _xwinclosewindow(window,task) {
...
export function _xwinmaxwindow(elmnt){
...
export function _xwinspawnwindow(elmnt) {
...
export { _xwinclosewindow,_xwinmaxwindow,_xwinspawnwindow}
